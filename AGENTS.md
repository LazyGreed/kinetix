...
- **Credential refresh and plugin runtime**:
  ...
  - `tests/plugin_auth_retry.rs`: Covers terminal `credential_expired` disabling across inference and token counting, startup seeding, auth retries, and scheduled refresh behavior.
